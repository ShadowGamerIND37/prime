...
async function seedDatabase() {
  ...
  const defaultSettings = [
    { key: 'panel_name', value: 'Prime Minecraft', description: 'Application display name' },
    { key: 'panel_logo', value: '', description: 'Panel Logo image URL or uploaded file path' },
    { key: 'favicon_name', value: 'Prime Minecraft', description: 'Favicon tab title' },
  ...
  if (!existingAdmin) {
    ...
    await query.run(
      ...
      [adminUuid, 'admin', 'admin@prime-minecraft.local', passwordHash, 'admin']
    );
