...
async function runTests() {
  console.log('🚀 Starting Prime Minecraft End-to-End Test Suite...\n');
  let token = '';
  ...
  try {
    ...
    await axios.post(`${BASE_URL}/api/servers/${nodeServerId}/files/content`, {
      ...
      content: JSON.stringify({ app: 'Prime Minecraft', version: '1.0' }, null, 2)
    }, authHeaders);
  ...
  console.log('\n🎉 All Prime Minecraft automated verification tests completed successfully!');
}
